...
- **Dependencies:** Add new dependencies using `npm install <package-name>`. For native modules, ensure they are compatible with Next.js and follow their specific installation instructions.
